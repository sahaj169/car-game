...
intro_background_pic =pygame.image.load("background.png")
instruction_background_pic =pygame.image.load("background2.png")
car_width=56
pause = False
# backgroundpic = pygame.image.load("download12.png")
    ...
    while intro:
        for event in pygame.event.get():
            if event.type==pygame.QUIT:
                ...
                quit()
                sys.exit()
        gamedisplays.blit(intro_background_pic,(0,0))
    ...
    while introduction:
        for event in pygame.event.get():
            if event.type==pygame.QUIT:
                ...
                quit()
                sys.exit()
        gamedisplays.blit(instruction_background_pic,(0,0))
...
def score_system(passed,score):
	...
	score_text =font.render("Score: "+ str(score),True,blue1)
	gamedisplays.blit(passed_text,(0,50))
